...
class Instruct(MetaWorldWrapper):
    ...
    def reset(self):
        addi_description = self.generate_sequence()
        self.task_description = f"{ALL_ENV_DES} There is a red cylinder on the table.\n\nTask description:\n{addi_description}"
        return super().reset()
    def step(self, keys):
        action = np.array([0, 0, 0, 0])
        if 'w' in keys: action[1] += 1
    ...
    def generate_sequence(self):
        ...
        if random.random() < 1/6:
            seq[random.choice([0, -1])] = 'Grip Red Cylinder'
        if random.random() < 1/6:
            point_dot = random.choice(["point", "dot"])
            seq[random.choice([0, -1])] = f'Go Red {point_dot}'
...
class ButtonPressTopdown(MetaWorldWrapper):
    ...
    def reset(self):
        addi_description = random.choice(self.addi_description)
        self.task_description = f"{ALL_ENV_DES} In front of the arm, there is a button vertically connected to a device, which is placed vertically on the table surface. The bottom of the button is black, and the top is red. The bottom of the device is black, and the top is yellow.\n\nTask Description:\n{addi_description}"
        return super().reset()
...
class ButtonPressTopdownWall(MetaWorldWrapper):
    ...
    def reset(self):
        addi_description = random.choice(self.addi_description)
        self.task_description = f"{ALL_ENV_DES} In front of the arm, there is a button vertically connected to a device, which is placed vertically on the table surface. The bottom of the button is black, and the top is red. The bottom of the device is black, and the top is yellow. Near the device, there is a wall, which is reddish-brown in color.\n\nTask Description:\n{addi_description}"
        return super().reset()
...
class ButtonPress(MetaWorldWrapper):
    ...
    def reset(self):
        ...
        self.task_description = f"{ALL_ENV_DES} In front of the arm, there is a button horizontally connected to a device, which is also placed {ly} on the table surface, facing the arm directly. The bottom of the button is black, and the top is red. The bottom of the device is black, and the top is yellow.\n\nTask description:\n{addi_description}"
        return super().reset()    
...
class ButtonPressWall(MetaWorldWrapper):
    def __init__(self):
        ...
        left_right_up_down = move_forward_and_up_left_right()
        self.addi_description = [
            f"The arm moves downward and to the forward to a horizontal position directly facing the button. Next, it moves forward{left_right_up_down[0]}, crossing over the wall, then moves forward{left_right_up_down[1]} to press the button."
            f"The arm moves downward to a horizontal position directly facing the button. Next, it moves forward{left_right_up_down[0]}, crossing over the wall, then moves forward{left_right_up_down[1]} to press the button."
            f"The arm moves downward and to the forward to a horizontal position directly facing the button. Next, it moves forward, crossing over the wall to press the button."
            f"The arm moves downward to a horizontal position directly facing the button. Next, it moves forward, crossing over the wall to press the button."
        ]
    def reset(self):
        addi_description = random.choice(self.addi_description)
        ly = random.choice(["horizontally", "lying down"])
        self.task_description = f"{ALL_ENV_DES} In front of the arm, there is a button horizontally connected to a device, which is also placed {ly} on the table surface, facing the arm directly. The bottom of the button is black, and the top is red. The bottom of the device is black, and the top is yellow. Near the device, there is a wall, which is reddish-brown in color.\n\nTask description:\n{addi_description}"
        return super().reset()
...
class PlateSlide(MetaWorldWrapper):
    ...
    def reset(self):
        addi_description = random.choice(self.addi_description)
        self.task_description = f"{ALL_ENV_DES} There is a soccer goal vertically placed on the table in front of the arm, directly facing it. There is a disc under the arm. The goal is red with a white net, and the disc is black.\n\nTask description:\n{addi_description}"
        return super().reset()
...
class PlateSlideBack(MetaWorldWrapper):
    def __init__(self):
        ...
        point_dot = random.choice(["point", "dot"])
        self.addi_description = [
            f"The arm moves upwards{left_right[0]}, then the arm moves forward to reach above the disc. {gripper_closes()}Then moves down{left_right[1]} forward to press the disc, and finally moves backward to drag the disc to the red {point_dot}."
            f"The arm moves forward to reach above the disc. {gripper_closes()}Then moves down forward to press the disc, and finally moves backward to pull the disc to the red {point_dot}."
        ]
    def reset(self):
        addi_description = random.choice(self.addi_description)
        self.task_description = f"{ALL_ENV_DES} There is a soccer goal vertically placed on the table in front of the arm, directly facing it. There is a disc in the middle of the goal. The goal is red with a white net, and the disc is black.\n\nTask description:\n{addi_description}"
        return super().reset()
...
class PlateSlideSide(MetaWorldWrapper):
    ...
    def reset(self):
        addi_description = random.choice(self.addi_description)
        self.task_description = f"{ALL_ENV_DES} There is a soccer goal vertically placed on the table in front of the arm, at the right front of the arm. There is a disc under the goal. The goal is red with a white net, and the disc is black.\n\nTask description:\n{addi_description}"
        return super().reset()
...
class PlateSlideBackSide(MetaWorldWrapper):
    def __init__(self):
        ...
        point_dot = random.choice(["point", "dot"])
        self.addi_description = [
            f"The arm moves upwards{left_right[0]}, then the arm moves right to reach above the disc. {gripper_closes()}Then moves down{left_right[1]} right to press the disc, and finally moves left to drag the disc to the red {point_dot}."
            f"The arm moves right to reach above the disc. {gripper_closes()}Then moves down right to press the disc, and finally moves left to pull the disc to the red {point_dot}."
        ]
    def reset(self):
        addi_description = random.choice(self.addi_description)
        self.task_description = f"{ALL_ENV_DES} There is a soccer goal vertically placed on the table in front of the arm, at the right front of the arm. There is a disc in front of the goal. The goal is red with a white net, and the disc is black.\n\nTask description:\n{addi_description}"
        return super().reset()
...
class FaucetOpen(MetaWorldWrapper):
    def __init__(self):
        ...
        self.addi_description = [
            f"The arm moves forward and to the right, reaching the right side of the faucet. {gripper_closes()}Next, it moves to the left, turning the faucet towards the left side."
        ]
    def reset(self):
        addi_description = random.choice(self.addi_description)
        self.task_description = f"{ALL_ENV_DES} In front of the arm, there is a faucet placed vertically on the table surface. The upper half of the faucet is red, and the lower half is gray.\n\nTask description:\n{addi_description}"
        return super().reset()
...
class FaucetClose(MetaWorldWrapper):
    def __init__(self):
        ...
        self.addi_description = [
            f"The arm moves forward and to the left, reaching the left side of the faucet. {gripper_closes()}Next, it moves to the right, turning the faucet towards the right side."
        ]
    def reset(self):
        addi_description = random.choice(self.addi_description)
        self.task_description = f"{ALL_ENV_DES} In front of the arm, there is a faucet placed vertically on the table surface. The upper half of the faucet is red, and the lower half is gray.\n\nTask description:\n{addi_description}"
...
class PickPlaceWall(MetaWorldWrapper):
    ...
    def reset(self):
        addi_description = random.choice(self.addi_description)
        self.task_description = f"{ALL_ENV_DES} There is a red cylinder on the table. Near the cylinder, there is a wall, which is reddish-brown in color.\n\nTask description:\n{addi_description}"
        return super().reset()
...
class PushBack(MetaWorldWrapper):
    ...
    def reset(self):
        addi_description = random.choice(self.addi_description)
        self.task_description = f"{ALL_ENV_DES} There is a brown cube on the table.\n\nTask description:\n{addi_description}"
        return super().reset()
...
#     def reset(self):
#         self.task_description = f"{ALL_ENV_DES} "
#         return super().reset()
